...
USING: ascii checksums combinators combinators.short-circuit
grouping kernel math math.order sequences uuid ;
...
: humanhash ( hexdigest -- hash )
    4 default-wordlist "-" make-humanhash ;
