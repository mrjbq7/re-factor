...
:: ACCBANDS ( high low close timeperiod -- realupperband realmiddleband reallowerband )
    ...
    begidx endidx inhigh inlow inclose timeperiod outbegidx outnbelement outrealupperband outrealmiddleband outreallowerband TA_ACCBANDS ta-check-success
...
:: ACOS ( real -- real )
    ...
    begidx endidx inreal outbegidx outnbelement outreal TA_ACOS ta-check-success
    outreal ;
...
:: AD ( high low close volume -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow inclose involume outbegidx outnbelement outreal TA_AD ta-check-success
    outreal ;
...
:: ADD ( real0 real1 -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal0 inreal1 outbegidx outnbelement outreal TA_ADD ta-check-success
    outreal ;
...
:: ADOSC ( high low close volume fastperiod slowperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow inclose involume fastperiod slowperiod outbegidx outnbelement outreal TA_ADOSC ta-check-success
    outreal ;
...
:: ADX ( high low close timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow inclose timeperiod outbegidx outnbelement outreal TA_ADX ta-check-success
    outreal ;
...
:: ADXR ( high low close timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow inclose timeperiod outbegidx outnbelement outreal TA_ADXR ta-check-success
    outreal ;
...
:: APO ( real fastperiod slowperiod matype -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal fastperiod slowperiod matype outbegidx outnbelement outreal TA_APO ta-check-success
    outreal ;
...
:: AROON ( high low timeperiod -- aroondown aroonup )
    ...
    begidx endidx inhigh inlow timeperiod outbegidx outnbelement outaroondown outaroonup TA_AROON ta-check-success
...
:: AROONOSC ( high low timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow timeperiod outbegidx outnbelement outreal TA_AROONOSC ta-check-success
    outreal ;
...
:: ASIN ( real -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal outbegidx outnbelement outreal TA_ASIN ta-check-success
    outreal ;
...
:: ATAN ( real -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal outbegidx outnbelement outreal TA_ATAN ta-check-success
    outreal ;
...
:: ATR ( high low close timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow inclose timeperiod outbegidx outnbelement outreal TA_ATR ta-check-success
    outreal ;
...
:: AVGPRICE ( open high low close -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outreal TA_AVGPRICE ta-check-success
    outreal ;
...
:: AVGDEV ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_AVGDEV ta-check-success
    outreal ;
...
:: BBANDS ( real timeperiod nbdevup nbdevdn matype -- realupperband realmiddleband reallowerband )
    ...
    len lookback make-double-array :> outrealmiddleband
    len lookback make-double-array :> outreallowerband
    begidx endidx inreal timeperiod nbdevup nbdevdn matype outbegidx outnbelement outrealupperband outrealmiddleband outreallowerband TA_BBANDS ta-check-success
    outrealupperband outrealmiddleband outreallowerband ;
...
:: BETA ( real0 real1 timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal0 inreal1 timeperiod outbegidx outnbelement outreal TA_BETA ta-check-success
    outreal ;
...
:: BOP ( open high low close -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outreal TA_BOP ta-check-success
    outreal ;
...
:: CCI ( high low close timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow inclose timeperiod outbegidx outnbelement outreal TA_CCI ta-check-success
    outreal ;
...
:: CDL2CROWS ( open high low close -- integer )
    ...
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDL2CROWS ta-check-success
    outinteger ;
...
:: CDL3BLACKCROWS ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDL3BLACKCROWS ta-check-success
    outinteger ;
...
:: CDL3INSIDE ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDL3INSIDE ta-check-success
    outinteger ;
...
:: CDL3LINESTRIKE ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDL3LINESTRIKE ta-check-success
    outinteger ;
...
:: CDL3OUTSIDE ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDL3OUTSIDE ta-check-success
    outinteger ;
...
:: CDL3STARSINSOUTH ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDL3STARSINSOUTH ta-check-success
    outinteger ;
...
:: CDL3WHITESOLDIERS ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDL3WHITESOLDIERS ta-check-success
    outinteger ;
...
:: CDLABANDONEDBABY ( open high low close penetration -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose penetration outbegidx outnbelement outinteger TA_CDLABANDONEDBABY ta-check-success
    outinteger ;
...
:: CDLADVANCEBLOCK ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLADVANCEBLOCK ta-check-success
    outinteger ;
...
:: CDLBELTHOLD ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLBELTHOLD ta-check-success
    outinteger ;
...
:: CDLBREAKAWAY ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLBREAKAWAY ta-check-success
    outinteger ;
...
:: CDLCLOSINGMARUBOZU ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLCLOSINGMARUBOZU ta-check-success
    outinteger ;
...
:: CDLCONCEALBABYSWALL ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLCONCEALBABYSWALL ta-check-success
    outinteger ;
...
:: CDLCOUNTERATTACK ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLCOUNTERATTACK ta-check-success
    outinteger ;
...
:: CDLDARKCLOUDCOVER ( open high low close penetration -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose penetration outbegidx outnbelement outinteger TA_CDLDARKCLOUDCOVER ta-check-success
    outinteger ;
...
:: CDLDOJI ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLDOJI ta-check-success
    outinteger ;
...
:: CDLDOJISTAR ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLDOJISTAR ta-check-success
    outinteger ;
...
:: CDLDRAGONFLYDOJI ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLDRAGONFLYDOJI ta-check-success
    outinteger ;
...
:: CDLENGULFING ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLENGULFING ta-check-success
    outinteger ;
...
:: CDLEVENINGDOJISTAR ( open high low close penetration -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose penetration outbegidx outnbelement outinteger TA_CDLEVENINGDOJISTAR ta-check-success
    outinteger ;
...
:: CDLEVENINGSTAR ( open high low close penetration -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose penetration outbegidx outnbelement outinteger TA_CDLEVENINGSTAR ta-check-success
    outinteger ;
...
:: CDLGAPSIDESIDEWHITE ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLGAPSIDESIDEWHITE ta-check-success
    outinteger ;
...
:: CDLGRAVESTONEDOJI ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLGRAVESTONEDOJI ta-check-success
    outinteger ;
...
:: CDLHAMMER ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLHAMMER ta-check-success
    outinteger ;
...
:: CDLHANGINGMAN ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLHANGINGMAN ta-check-success
    outinteger ;
...
:: CDLHARAMI ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLHARAMI ta-check-success
    outinteger ;
...
:: CDLHARAMICROSS ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLHARAMICROSS ta-check-success
    outinteger ;
...
:: CDLHIGHWAVE ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLHIGHWAVE ta-check-success
    outinteger ;
...
:: CDLHIKKAKE ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLHIKKAKE ta-check-success
    outinteger ;
...
:: CDLHIKKAKEMOD ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLHIKKAKEMOD ta-check-success
    outinteger ;
...
:: CDLHOMINGPIGEON ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLHOMINGPIGEON ta-check-success
    outinteger ;
...
:: CDLIDENTICAL3CROWS ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLIDENTICAL3CROWS ta-check-success
    outinteger ;
...
:: CDLINNECK ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLINNECK ta-check-success
    outinteger ;
...
:: CDLINVERTEDHAMMER ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLINVERTEDHAMMER ta-check-success
    outinteger ;
...
:: CDLKICKING ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLKICKING ta-check-success
    outinteger ;
...
:: CDLKICKINGBYLENGTH ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLKICKINGBYLENGTH ta-check-success
    outinteger ;
...
:: CDLLADDERBOTTOM ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLLADDERBOTTOM ta-check-success
    outinteger ;
...
:: CDLLONGLEGGEDDOJI ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLLONGLEGGEDDOJI ta-check-success
    outinteger ;
...
:: CDLLONGLINE ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLLONGLINE ta-check-success
    outinteger ;
...
:: CDLMARUBOZU ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLMARUBOZU ta-check-success
    outinteger ;
...
:: CDLMATCHINGLOW ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLMATCHINGLOW ta-check-success
    outinteger ;
...
:: CDLMATHOLD ( open high low close penetration -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose penetration outbegidx outnbelement outinteger TA_CDLMATHOLD ta-check-success
    outinteger ;
...
:: CDLMORNINGDOJISTAR ( open high low close penetration -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose penetration outbegidx outnbelement outinteger TA_CDLMORNINGDOJISTAR ta-check-success
    outinteger ;
...
:: CDLMORNINGSTAR ( open high low close penetration -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose penetration outbegidx outnbelement outinteger TA_CDLMORNINGSTAR ta-check-success
    outinteger ;
...
:: CDLONNECK ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLONNECK ta-check-success
    outinteger ;
...
:: CDLPIERCING ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLPIERCING ta-check-success
    outinteger ;
...
:: CDLRICKSHAWMAN ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLRICKSHAWMAN ta-check-success
    outinteger ;
...
:: CDLRISEFALL3METHODS ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLRISEFALL3METHODS ta-check-success
    outinteger ;
...
:: CDLSEPARATINGLINES ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLSEPARATINGLINES ta-check-success
    outinteger ;
...
:: CDLSHOOTINGSTAR ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLSHOOTINGSTAR ta-check-success
    outinteger ;
...
:: CDLSHORTLINE ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLSHORTLINE ta-check-success
    outinteger ;
...
:: CDLSPINNINGTOP ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLSPINNINGTOP ta-check-success
    outinteger ;
...
:: CDLSTALLEDPATTERN ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLSTALLEDPATTERN ta-check-success
    outinteger ;
...
:: CDLSTICKSANDWICH ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLSTICKSANDWICH ta-check-success
    outinteger ;
...
:: CDLTAKURI ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLTAKURI ta-check-success
    outinteger ;
...
:: CDLTASUKIGAP ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLTASUKIGAP ta-check-success
    outinteger ;
...
:: CDLTHRUSTING ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLTHRUSTING ta-check-success
    outinteger ;
...
:: CDLTRISTAR ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLTRISTAR ta-check-success
    outinteger ;
...
:: CDLUNIQUE3RIVER ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLUNIQUE3RIVER ta-check-success
    outinteger ;
...
:: CDLUPSIDEGAP2CROWS ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLUPSIDEGAP2CROWS ta-check-success
    outinteger ;
...
:: CDLXSIDEGAP3METHODS ( open high low close -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inopen inhigh inlow inclose outbegidx outnbelement outinteger TA_CDLXSIDEGAP3METHODS ta-check-success
    outinteger ;
...
:: CEIL ( real -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal outbegidx outnbelement outreal TA_CEIL ta-check-success
    outreal ;
...
:: CMO ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_CMO ta-check-success
    outreal ;
...
:: CORREL ( real0 real1 timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal0 inreal1 timeperiod outbegidx outnbelement outreal TA_CORREL ta-check-success
    outreal ;
...
:: COS ( real -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal outbegidx outnbelement outreal TA_COS ta-check-success
    outreal ;
...
:: COSH ( real -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal outbegidx outnbelement outreal TA_COSH ta-check-success
    outreal ;
...
:: DEMA ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_DEMA ta-check-success
    outreal ;
...
:: DIV ( real0 real1 -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal0 inreal1 outbegidx outnbelement outreal TA_DIV ta-check-success
    outreal ;
...
:: DX ( high low close timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow inclose timeperiod outbegidx outnbelement outreal TA_DX ta-check-success
    outreal ;
...
:: EMA ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_EMA ta-check-success
    outreal ;
...
:: EXP ( real -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal outbegidx outnbelement outreal TA_EXP ta-check-success
    outreal ;
...
:: FLOOR ( real -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal outbegidx outnbelement outreal TA_FLOOR ta-check-success
    outreal ;
...
:: HT_DCPERIOD ( real -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal outbegidx outnbelement outreal TA_HT_DCPERIOD ta-check-success
    outreal ;
...
:: HT_DCPHASE ( real -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal outbegidx outnbelement outreal TA_HT_DCPHASE ta-check-success
    outreal ;
...
:: HT_PHASOR ( real -- inphase quadrature )
    ...
    begidx endidx inreal outbegidx outnbelement outinphase outquadrature TA_HT_PHASOR ta-check-success
...
:: HT_SINE ( real -- sine leadsine )
    ...
    begidx endidx inreal outbegidx outnbelement outsine outleadsine TA_HT_SINE ta-check-success
    outsine outleadsine ;
...
:: HT_TRENDLINE ( real -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal outbegidx outnbelement outreal TA_HT_TRENDLINE ta-check-success
    outreal ;
...
:: HT_TRENDMODE ( real -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inreal outbegidx outnbelement outinteger TA_HT_TRENDMODE ta-check-success
    outinteger ;
...
:: IMI ( open close timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inopen inclose timeperiod outbegidx outnbelement outreal TA_IMI ta-check-success
    outreal ;
...
:: KAMA ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_KAMA ta-check-success
    outreal ;
...
:: LINEARREG ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_LINEARREG ta-check-success
    outreal ;
...
:: LINEARREG_ANGLE ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_LINEARREG_ANGLE ta-check-success
    outreal ;
...
:: LINEARREG_INTERCEPT ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_LINEARREG_INTERCEPT ta-check-success
    outreal ;
...
:: LINEARREG_SLOPE ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_LINEARREG_SLOPE ta-check-success
    outreal ;
...
:: LN ( real -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal outbegidx outnbelement outreal TA_LN ta-check-success
    outreal ;
...
:: LOG10 ( real -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal outbegidx outnbelement outreal TA_LOG10 ta-check-success
    outreal ;
...
:: MA ( real timeperiod matype -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod matype outbegidx outnbelement outreal TA_MA ta-check-success
    outreal ;
...
:: MACD ( real fastperiod slowperiod signalperiod -- macd macdsignal macdhist )
    ...
    begidx endidx inreal fastperiod slowperiod signalperiod outbegidx outnbelement outmacd outmacdsignal outmacdhist TA_MACD ta-check-success
...
:: MACDEXT ( real fastperiod fastmatype slowperiod slowmatype signalperiod signalmatype -- macd macdsignal macdhist )
    ...
    len lookback make-double-array :> outmacdsignal
    len lookback make-double-array :> outmacdhist
    begidx endidx inreal fastperiod fastmatype slowperiod slowmatype signalperiod signalmatype outbegidx outnbelement outmacd outmacdsignal outmacdhist TA_MACDEXT ta-check-success
    outmacd outmacdsignal outmacdhist ;
...
:: MACDFIX ( real signalperiod -- macd macdsignal macdhist )
    ...
    len lookback make-double-array :> outmacdsignal
    len lookback make-double-array :> outmacdhist
    begidx endidx inreal signalperiod outbegidx outnbelement outmacd outmacdsignal outmacdhist TA_MACDFIX ta-check-success
    outmacd outmacdsignal outmacdhist ;
...
:: MAMA ( real fastlimit slowlimit -- mama fama )
    ...
    begidx endidx inreal fastlimit slowlimit outbegidx outnbelement outmama outfama TA_MAMA ta-check-success
    outmama outfama ;
...
:: MAVP ( real periods minperiod maxperiod matype -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal inperiods minperiod maxperiod matype outbegidx outnbelement outreal TA_MAVP ta-check-success
    outreal ;
...
:: MAX ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_MAX ta-check-success
    outreal ;
...
:: MAXINDEX ( real timeperiod -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inreal timeperiod outbegidx outnbelement outinteger TA_MAXINDEX ta-check-success
...
:: MEDPRICE ( high low -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow outbegidx outnbelement outreal TA_MEDPRICE ta-check-success
    outreal ;
...
:: MFI ( high low close volume timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow inclose involume timeperiod outbegidx outnbelement outreal TA_MFI ta-check-success
    outreal ;
...
:: MIDPOINT ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_MIDPOINT ta-check-success
    outreal ;
...
:: MIDPRICE ( high low timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow timeperiod outbegidx outnbelement outreal TA_MIDPRICE ta-check-success
    outreal ;
...
:: MIN ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_MIN ta-check-success
    outreal ;
...
:: MININDEX ( real timeperiod -- integer )
    ...
    len lookback make-int-array :> outinteger
    begidx endidx inreal timeperiod outbegidx outnbelement outinteger TA_MININDEX ta-check-success
    lookback len outinteger <slice> [ begidx + ] map! drop
    outinteger ;
...
:: MINMAX ( real timeperiod -- min max )
    ...
    begidx endidx inreal timeperiod outbegidx outnbelement outmin outmax TA_MINMAX ta-check-success
    outmin outmax ;
...
:: MINMAXINDEX ( real timeperiod -- minidx maxidx )
    ...
    begidx endidx inreal timeperiod outbegidx outnbelement outminidx outmaxidx TA_MINMAXINDEX ta-check-success
...
:: MINUS_DI ( high low close timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow inclose timeperiod outbegidx outnbelement outreal TA_MINUS_DI ta-check-success
    outreal ;
...
:: MINUS_DM ( high low timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow timeperiod outbegidx outnbelement outreal TA_MINUS_DM ta-check-success
    outreal ;
...
:: MOM ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_MOM ta-check-success
    outreal ;
...
:: MULT ( real0 real1 -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal0 inreal1 outbegidx outnbelement outreal TA_MULT ta-check-success
    outreal ;
...
:: NATR ( high low close timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow inclose timeperiod outbegidx outnbelement outreal TA_NATR ta-check-success
    outreal ;
...
:: OBV ( real volume -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal involume outbegidx outnbelement outreal TA_OBV ta-check-success
    outreal ;
...
:: PLUS_DI ( high low close timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow inclose timeperiod outbegidx outnbelement outreal TA_PLUS_DI ta-check-success
    outreal ;
...
:: PLUS_DM ( high low timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow timeperiod outbegidx outnbelement outreal TA_PLUS_DM ta-check-success
    outreal ;
...
:: PPO ( real fastperiod slowperiod matype -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal fastperiod slowperiod matype outbegidx outnbelement outreal TA_PPO ta-check-success
    outreal ;
...
:: ROC ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_ROC ta-check-success
    outreal ;
...
:: ROCP ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_ROCP ta-check-success
    outreal ;
...
:: ROCR ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_ROCR ta-check-success
    outreal ;
...
:: ROCR100 ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_ROCR100 ta-check-success
    outreal ;
...
:: RSI ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_RSI ta-check-success
    outreal ;
...
:: SAR ( high low acceleration maximum -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow acceleration maximum outbegidx outnbelement outreal TA_SAR ta-check-success
    outreal ;
...
:: SAREXT ( high low startvalue offsetonreverse accelerationinitlong accelerationlong accelerationmaxlong accelerationinitshort accelerationshort accelerationmaxshort -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow startvalue offsetonreverse accelerationinitlong accelerationlong accelerationmaxlong accelerationinitshort accelerationshort accelerationmaxshort outbegidx outnbelement outreal TA_SAREXT ta-check-success
    outreal ;
...
:: SIN ( real -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal outbegidx outnbelement outreal TA_SIN ta-check-success
    outreal ;
...
:: SINH ( real -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal outbegidx outnbelement outreal TA_SINH ta-check-success
    outreal ;
...
:: SMA ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_SMA ta-check-success
    outreal ;
...
:: SQRT ( real -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal outbegidx outnbelement outreal TA_SQRT ta-check-success
    outreal ;
...
:: STDDEV ( real timeperiod nbdev -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod nbdev outbegidx outnbelement outreal TA_STDDEV ta-check-success
    outreal ;
...
:: STOCH ( high low close fastk-period slowk-period slowk-matype slowd-period slowd-matype -- slowk slowd )
    ...
    begidx endidx inhigh inlow inclose fastk-period slowk-period slowk-matype slowd-period slowd-matype outbegidx outnbelement outslowk outslowd TA_STOCH ta-check-success
    outslowk outslowd ;
...
:: STOCHF ( high low close fastk-period fastd-period fastd-matype -- fastk fastd )
    ...
    begidx endidx inhigh inlow inclose fastk-period fastd-period fastd-matype outbegidx outnbelement outfastk outfastd TA_STOCHF ta-check-success
    outfastk outfastd ;
...
:: STOCHRSI ( real timeperiod fastk-period fastd-period fastd-matype -- fastk fastd )
    ...
    len lookback make-double-array :> outfastk
    len lookback make-double-array :> outfastd
    begidx endidx inreal timeperiod fastk-period fastd-period fastd-matype outbegidx outnbelement outfastk outfastd TA_STOCHRSI ta-check-success
    outfastk outfastd ;
...
:: SUB ( real0 real1 -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal0 inreal1 outbegidx outnbelement outreal TA_SUB ta-check-success
    outreal ;
...
:: SUM ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_SUM ta-check-success
    outreal ;
...
:: T3 ( real timeperiod vfactor -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod vfactor outbegidx outnbelement outreal TA_T3 ta-check-success
    outreal ;
...
:: TAN ( real -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal outbegidx outnbelement outreal TA_TAN ta-check-success
    outreal ;
...
:: TANH ( real -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal outbegidx outnbelement outreal TA_TANH ta-check-success
    outreal ;
...
:: TEMA ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_TEMA ta-check-success
    outreal ;
...
:: TRANGE ( high low close -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow inclose outbegidx outnbelement outreal TA_TRANGE ta-check-success
    outreal ;
...
:: TRIMA ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_TRIMA ta-check-success
    outreal ;
...
:: TRIX ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_TRIX ta-check-success
    outreal ;
...
:: TSF ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_TSF ta-check-success
    outreal ;
...
:: TYPPRICE ( high low close -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow inclose outbegidx outnbelement outreal TA_TYPPRICE ta-check-success
    outreal ;
...
:: ULTOSC ( high low close timeperiod1 timeperiod2 timeperiod3 -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow inclose timeperiod1 timeperiod2 timeperiod3 outbegidx outnbelement outreal TA_ULTOSC ta-check-success
    outreal ;
...
:: VAR ( real timeperiod nbdev -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod nbdev outbegidx outnbelement outreal TA_VAR ta-check-success
    outreal ;
...
:: WCLPRICE ( high low close -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow inclose outbegidx outnbelement outreal TA_WCLPRICE ta-check-success
    outreal ;
...
:: WILLR ( high low close timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inhigh inlow inclose timeperiod outbegidx outnbelement outreal TA_WILLR ta-check-success
    outreal ;
...
:: WMA ( real timeperiod -- real )
    ...
    len lookback make-double-array :> outreal
    begidx endidx inreal timeperiod outbegidx outnbelement outreal TA_WMA ta-check-success
    outreal ;
